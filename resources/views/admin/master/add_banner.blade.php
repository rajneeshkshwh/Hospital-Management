	...
	<script type="text/javascript">
      ...
      <?php if(isset($list)){ ?>    
          <div class="row">
	        <div class="col-lg-12">
	          <div class="card">
	            <div class="card-title text-dark"><i class="fa fa-table"></i> Banner Slider</div>
	            <div style="width: 100%;text-align: right;padding-right: 20px;padding-top: 10px;">
                        <a href="{{ url('admin/addnewbanner')}}"><button class="btn btn-info btn-round">Add New</button></a>
                      </div>
	            <div class="card-body">
	              ...
	              <table id="example" class="table table-bordered" style="text-align: center;">
	                ...
	                <tbody>
                        ...
                        @foreach ($banner_list as $banner)
                         <tr>
                           <td>{{ $count++ }}</td>
                           <td style="width: 10px;">{{ $result = mb_substr( $banner->Title, 0,10) }}</td>
                      	   <td>{{ $result = mb_substr( $banner->Description, 0,10) }}..  </td>
                           <td><img src="{{ url('')}}/{{ $banner->Photo }}" width="200px" height="70px"></td>
                           <td>
                              <a href="{{ url('admin/edit_banner/'.$banner->UniqueId) }}"><button class="btn btn-info btn-round">Edit</button></a>
                              <a href="{{ url('admin/delete_banner/'.$banner->UniqueId) }}"><button OnClick="return confirm('Are You Sure Want to Delete?')" class="btn btn-danger btn-round">Delete</button></a>
                           </td>
                        </tr>
                         @endforeach
                         <?php } ?>
     ...
     <?php if(isset($add)){ ?>
	      <div class="row">
				<div class="col-lg-12">
				   <div class="card">
				     <div class="card-body">
					    <div class="card-title text-dark">New Banner Slider </div>
					    <hr>
					    <form  enctype="multipart/form-data" id="" method="post" action="{{ url('admin/add_banner')}}">
	                     <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
	                     
						 <div class="form-group row">
						  <label for="input-21" class="col-sm-2 col-form-label">Banner Title </label>
						  <div class="col-sm-4">
			            ...
			            <div class="form-group row">
						 ...
						 <div class="form-group row">
						 	<label for="input-24" class="col-sm-2 col-form-label">Banner Slider Image</label>
							  <div class="col-sm-4">
						...
						<div class="form-group row">
						 ...
						 <div class="form-group row" style="text-align: center;">
						     ...
						     <div class="col-sm-10">
								...
								<a href="{{ url('/admin/banner') }}" type="reset" name="reset" class="btn btn-danger shadow-dark px-3">Cancel</a>
							  </div>
							</div>
						</form>
					 </div>
     ...
     <?php if(isset($edit)){ ?>
	      <div class="row">
				<div class="col-lg-12">
				   <div class="card">
				     <div class="card-body">
					   <div class="card-title text-dark">Edit Banner- Master </div>
					   <hr>
					    <form enctype="multipart/form-data" id="" method="post" action="{{ url('/admin/edit_banner/'.$c[0]->UniqueId) }}">
	                     <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
