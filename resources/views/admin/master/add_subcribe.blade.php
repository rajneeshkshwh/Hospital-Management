	...
	<script type="text/javascript">
      ...
      <?php if(isset($list)){ ?>    
          <div class="row">
	        <div class="col-lg-12">
	          <div class="card">
	            <div class="card-header"><i class="fa fa-table"></i> Subcribe List </div>
	          <!--   <div style="width: 100%;text-align: right;padding-right: 20px;padding-top: 10px;">
                        <a href="{{ url('admin/addnewsubcribe')}}"><button class="btn btn-info btn-round">Add New</button></a>
                      </div> -->
	            <div class="card-body">
	              ...
	              <table id="example" class="table table-bordered" style="text-align: center;">
	                ...
	                <tbody>
	                    <?php $count = 1; if(isset($subcribe_list) && !empty($subcribe_list)){ ?>
                        @foreach ($subcribe_list as $subcribe)
                         <tr>
                           <td>{{ $count++ }}</td>
                           <td>{{ $subcribe->EmailId }}</td>
                      	  
                           <td>
                              <a href="{{ url('admin/edit_subscribe/'.$subcribe->UniqueId) }}"><button class="btn btn-info btn-round">Edit</button></a>
                              <a href="{{ url('admin/delete_subscribe/'.$subcribe->UniqueId) }}"><button OnClick="return confirm('Are You Sure Want to Delete?')" class="btn btn-danger btn-round">Delete</button></a>
                           </td>
                        </tr>
                         @endforeach
                         <?php } ?>
     ...
     <?php if(isset($add)){ ?>
	      <div class="row">
				<div class="col-lg-12">
				   <div class="card">
				     <div class="card-body">
					    <div class="card-title text-dark">New subcribe </div>
					    <hr>
     ...
     <?php if(isset($edit)){ ?>
	      <div class="row">
				<div class="col-lg-12">
				   <div class="card">
				     <div class="card-body">
					   <div class="card-title text-dark">Edit subcribe </div>
					   <hr>
