            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mini-title inner-style-2">
                        <h3>Portfolio</h3>
                        <p><a href="{{url('index')}}">Home</a> <span class="fa fa-angle-right"></span> <a href="{{url('portfolio')}}">Portfolio</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="section-content">
                <div class="row clearfix">
                    <div class="gallery-filter-item text-center">
                        <ul class="gallery-filter">
                            <li class="active"><a href="#" data-filter="*" class="current">All</a></li>
                              <?php $count = 1; if(isset($portfolio_list_type) && !empty($portfolio_list_type)){ ?>
                                      @foreach ($portfolio_list_type as $list)
                            <li class=""><a href="#" data-filter=".{{ $list->Type }}" class="current">{{ $list->Type }}</a></li>
                           @endforeach
                                       <?php } ?>
                        </ul>
                    </div>
                    ...
                    <div class="gallery col-3 gutter">
                        ...
                        <div class="gallery-item {{ $list->Type }}">
                            <div class="thumb">
                                <img class="portfol"  id="appointment_form" src="{{ url('')}}/{{ $list->Photo }}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn" >
                                            <a href="{{ url('')}}/{{ $list->Photo }}" data-fancybox-group="gallery" class="lightbox-image" > <i class="pe-7s-plus"></i> </a>
                                        </div>
